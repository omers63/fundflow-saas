...
flowchart TB
    ...
    subgraph loans [Loans hub]
        active[Active loans]
        history[Loan history]
        settle[Settle loan tab]
        apply[Request wizard]
    end
...
flowchart TB
    subgraph portal [Member portal]
        UI[Pages widgets forms]
        VAL[Validation errors]
        DBN[Database notifications bell]
    end

    subgraph comms [Outbound communications]
        EMAIL[Email]
        SMS[SMS]
        WA[WhatsApp]
    end
    ...
    subgraph docs [Documents]
        PDF[Monthly statement PDF]
        EXP[Future exports CSV Excel]
    end

    subgraph human [Human-authored]
        DM[Direct messages]
        ADM[Admin broadcast notifications]
