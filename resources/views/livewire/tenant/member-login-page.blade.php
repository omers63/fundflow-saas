<div class="member-login-shell">
    <div class="member-login-shell__inner">
                    ...
                    <form wire:submit="login" class="member-login-form">
                        ...
                        <button type="submit" wire:loading.attr="disabled" class="member-login-submit">
                            ...
                            <span wire:loading wire:target="login" class="member-login-submit__loading">
                                <svg class="member-login-submit__spinner" fill="none" viewBox="0 0 24 24"
                                    aria-hidden="true">
    ...
    <section class="member-login-cta" aria-labelledby="member-login-cta-heading">
        <h2 id="member-login-cta-heading" class="member-login-cta__title">
            {{ __('Ready to Join Your Family Fund?') }}
        </h2>
        <p class="member-login-cta__text">
            {{ __('Apply for membership today and start building a stronger financial future together.') }}
        </p>
        <div class="member-login-cta__actions">
            <a href="{{ route('tenant.membership') }}" class="member-login-cta__btn member-login-cta__btn--primary">
                {{ __('Apply for membership') }}
            </a>
            <a href="{{ route('tenant.application.status') }}"
                class="member-login-cta__btn member-login-cta__btn--secondary">
