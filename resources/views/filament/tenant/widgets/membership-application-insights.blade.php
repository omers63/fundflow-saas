...
@php
    $hero = $d['pending'] > 0
        ...
        : ['title' => __('Inbox clear'), 'subtitle' => __('No applications awaiting review'), 'tone' => 'success'];
@endphp
            ...
            <div
                ...
                <div class="px-3 py-2.5">
                    ...
                    <p class="mt-1.5 text-lg font-bold tabular-nums text-gray-900 dark:text-white">
                        <x-member::amount :value="$fees['pending_total']" :currency="$currency" :precision="0" />
                    </p>
                    ...
                    <p class="mt-0.5 text-[10px] text-rose-600 dark:text-rose-400">
                        {{ __('Arrears: :count (:amount)', [
                            'count' => $fees['subscription_arrears_count'],
                            'amount' => MoneyDisplay::format($fees['subscription_arrears_total'], $currency, precision: 0) ?? '—',
                        ]) }}
                    </p>
                    <div class="mt-2">
