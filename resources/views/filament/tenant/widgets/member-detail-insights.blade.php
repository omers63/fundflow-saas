                ...
                <div
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        <h4 class="text-[11px] font-semibold uppercase tracking-wider text-gray-500">
                            {{ __('6-month contributions') }}</h4>
                    </div>
                </div>
                <div class="flex h-20 items-end gap-1.5 px-3 py-3">
                    @foreach ($d['trend'] as $month)
                        @php
                            $barH = max(12, (int) round(($month['posted'] / $d['trend_max']) * 100));
                        @endphp
                        <div class="flex flex-1 flex-col items-center gap-0.5">
                            <span
                                class="text-[10px] font-semibold tabular-nums text-gray-500">{{ $month['posted'] ?: '·' }}</span>
