...
@if ($kpis !== [])
    <div class="ff-sms-clearing-kpis grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
        @foreach ($kpis as $kpi)
            <a href="{{ $kpi['url'] }}"
                class="ff-sms-clearing-kpi rounded-xl border border-gray-200 bg-white p-3 shadow-sm transition hover:border-sky-200 hover:bg-sky-50/40 dark:border-gray-700 dark:bg-gray-900 dark:hover:border-sky-800/40 dark:hover:bg-sky-950/20">
