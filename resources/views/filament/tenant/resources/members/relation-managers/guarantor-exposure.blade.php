    ...
    <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div class="rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm dark:border-white/10 dark:bg-gray-900/60">
            ...
            <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-white">
                {!! \App\Filament\Support\MoneyDisplay::html($summary['total_exposure'], $currency)?->toHtml() !!}
            </p>
        </div>
        <div class="rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm dark:border-white/10 dark:bg-gray-900/60">
            <p class="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
            ...
            <p class="mt-1 text-lg font-semibold text-gray-900 dark:text-white">
                {!! \App\Filament\Support\MoneyDisplay::html($summary['max_single_exposure'], $currency)?->toHtml() !!}
            </p>
        </div>
        <div class="rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm dark:border-white/10 dark:bg-gray-900/60">
            <p class="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">
