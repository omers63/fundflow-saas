...
<div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
    <div
        ...
        <div class="flex items-center justify-between gap-2 border-b border-gray-100 px-3 py-2 dark:border-gray-700">
            ...
            <span @class([
                ...
                'bg-violet-100 text-violet-800 dark:bg-violet-900/40 dark:text-violet-200' => ($cycle['status_key'] ?? '') === 'loan_repayment',
        ...
        <div class="space-y-2 px-3 py-2.5 text-xs text-gray-600 dark:text-gray-300">
            ...
            @if ($cycle['under_loan_repayment'] ?? false)
                <p
                    class="rounded-lg bg-violet-50 px-2 py-1.5 text-sm font-semibold text-violet-900 dark:bg-violet-950/30 dark:text-violet-100">
                    {{ $cycle['loan_repayment_message'] ?? __('Under loan repayment') }}
                </p>
            @else
                <div class="flex justify-between gap-2">
    ...
    @if ($loanCard)
        <div
            ...
            <div
                class="flex items-center justify-between gap-2 border-b border-violet-100/80 px-3 py-2 dark:border-violet-500/20">
                <div class="flex items-center gap-1.5">
