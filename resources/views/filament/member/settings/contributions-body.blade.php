...
@endphp
    ...
    @if ($isSponsoredDependent)
        <x-filament::section class="mb-6" icon="heroicon-o-information-circle" icon-color="warning">
            ...
            <x-slot name="description">
                {!! __('Your household parent sets your monthly contribution from <strong>My dependents</strong>. To add or remove dependents or request independence, use requests on that page.') !!}
            </x-slot>
        </x-filament::section>
    @endif
