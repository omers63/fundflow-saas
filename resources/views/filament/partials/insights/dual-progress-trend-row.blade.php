    ...
    <div class="flex min-w-0 items-start gap-1.5">
        ...
        <div class="min-w-0 flex-1 space-y-1">
            <div class="flex min-w-0 items-center gap-1.5">
                ...
                <span
                    class="w-8 shrink-0 text-right text-[10px] font-semibold tabular-nums {{ $textTone($month['tone']) }}">
            ...
            <div class="flex min-w-0 items-center gap-1.5">
                ...
                <span
                    class="w-8 shrink-0 text-right text-[10px] font-semibold tabular-nums {{ $textTone($month['amount_tone']) }}">
