...
<x-layouts.tenant-public :title="$fundName">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
                <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="text-sm text-gray-500 mt-1">{{ __('Active members') }}</div>
                </div>
                <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                    <div class="text-3xl font-bold text-emerald-600">12+</div>
                    <div class="text-sm text-gray-500 mt-1">{{ __('Months track record') }}</div>
                </div>
                <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                    <div class="text-3xl font-bold text-emerald-600">100%</div>
                    <div class="text-sm text-gray-500 mt-1">{{ __('Transparent') }}</div>
                </div>
                <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                    <div class="text-3xl font-bold text-emerald-600">{{ __('Low') }}</div>
                    <div class="text-sm text-gray-500 mt-1">{{ __('Interest rates') }}</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="features" class="py-20 sm:py-28 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">{{ __('Everything you need to grow') }}
                </h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    {{ __('Our fund provides a complete financial ecosystem for family members to save, grow, and access funds when needed.') }}
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Monthly contributions') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                        {{ __('Flexible contribution amounts tailored to each member. Build your savings consistently with automated tracking and receipts.') }}
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Affordable loans') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                        {{ __('Access loans at favorable rates after one year of membership. Funded from the collective fund with fair, transparent terms.') }}
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Family structure') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                        {{ __('Support parent-dependent relationships where parents can manage contributions for their dependents with flexible allocation.') }}
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">
                        {{ __('Admin dashboard & transparent accounting') }}
                    </h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Dual account system') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                        {{ __('Each member maintains a Cash account for incoming funds and a Fund account for long-term savings. Clear separation, easy tracking.') }}
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Secure & private') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                        {{ __('Your fund operates in its own isolated environment. Data is private to your family with enterprise-grade security.') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="how-it-works" class="py-20 sm:py-28 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">{{ __('How it works') }}</h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    {{ __('Getting started is simple. Join, contribute, and benefit from the collective fund.') }}</p>
            </div>
            ...
            <div class="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
                <div class="text-center">
                    <div
                        ...
                        1</div>
                    <h3 class="font-semibold text-gray-900 mb-2">{{ __('Apply') }}</h3>
                ...
                <div class="text-center">
                    <div
                        class="w-14 h-14 bg-emerald-600 text-white rounded-2xl flex items-center justify-center text-xl font-bold mx-auto mb-4">
                        2</div>
                    <h3 class="font-semibold text-gray-900 mb-2">{{ __('Get approved') }}</h3>
                    <p class="text-sm text-gray-600">
                        {{ __('Fund administrators review your application and activate your membership.') }}</p>
                </div>
                <div class="text-center">
                    <div
                        class="w-14 h-14 bg-emerald-600 text-white rounded-2xl flex items-center justify-center text-xl font-bold mx-auto mb-4">
                        3</div>
                    <h3 class="font-semibold text-gray-900 mb-2">{{ __('Contribute') }}</h3>
                    <p class="text-sm text-gray-600">
                        {{ __('Make monthly contributions that are tracked in your personal fund account.') }}</p>
                </div>
                <div class="text-center">
                    <div
                        class="w-14 h-14 bg-emerald-600 text-white rounded-2xl flex items-center justify-center text-xl font-bold mx-auto mb-4">
                        4</div>
                    <h3 class="font-semibold text-gray-900 mb-2">{{ __('Access loans') }}</h3>
                    <p class="text-sm text-gray-600">
                        {{ __('After 12 months, apply for affordable loans funded by the collective.') }}</p>
                </div>
            </div>
        </div>
    </section>
