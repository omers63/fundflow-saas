...
/**
 * Real CSV statement lines on master cash awaiting mirror/post workflow.
 *
 * @extends Relation<BankTransaction, Account>
 */
final class MasterAccountBankLinesAwaitingPostingRelation extends Relation
{
    ...
    public function addConstraints(): void
    {
        ...
        if (! $this->parent->is_master || $this->parent->type !== 'cash') {
        ...
        app(BankClearingMatchService::class)
            ->applyBankLinesAwaitingPostingScope($this->query);
    }
