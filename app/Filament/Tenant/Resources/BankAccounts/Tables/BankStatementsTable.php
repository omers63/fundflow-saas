            ...
            $table
                ...
                ->filters([
                    SelectFilter::make('status')
                        ->options(BankStatement::statusOptions()),
                    SelectFilter::make('bank_name')
                        ...
                        ->options(fn (): array => BankStatement::query()
                            ...
                            ->all()),
                    DateColumnRangeFilter::make('statement_date', __('Statement date')),
                    DateColumnRangeFilter::make('imported_at', __('Imported')),
                ])
                ->recordUrl(fn (Model $record): string => BankAccountsResource::getUrl('view', ['record' => $record]))
                ->recordActions(TableRecordActionGroups::wrap([
                    ViewBankStatementAction::make(),
                    Action::make('delete')
