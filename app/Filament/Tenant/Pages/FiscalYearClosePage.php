...
class FiscalYearClosePage extends Page implements HasForms
{
    ...
    protected string $embeddedView = 'filament.tenant.pages.embedded.fiscal-year-close';
    ...
    public function mount(bool $embedded = false): void
    {
        ...
        $this->redirectToAuditWorkspaceUnlessEmbedded('fiscal');
    ...
    protected function workspacePanelActions(): array
    {
        return [
            Action::make('open_settings')
                ...
                ->url(SettingsTabRegistry::url('fiscal-calendar::tab')),
