...
class MemberCashLedgerTableWidget extends TableWidget
{
    ...
    public function table(Table $table): Table
    {
        return ViewAccountTransactionAction::configure($table
            ->heading(__('Cash transactions'))
            ->description(__('Credits and debits on your cash account.'))
            ->columns([
