        ...
        return [
            ...
            'delinquency_digest' => [
                ...
                'en' => [
                    ...
                    'body' => '{{overdue}} overdue installment(s) · {{members_in_arrears}} member(s) in arrears · {{arrears_members}} with contribution arrears · {{arrears}} contribution period(s) · {{delinquent}} policy-delinquent member(s) · {{guarantor}} guarantor exposure · {{transferred}} guarantor transferred.',
                ],
                'ar' => [
                    'subject' => 'ملخص التعثر',
