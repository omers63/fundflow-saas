...
final class ReconciliationExceptionPresenter
{
    ...
    public static function recommendedAction(ReconciliationException $record): string
    {
        ...
        return match ($record->exception_code) {
            ...
            'GUARANTOR_BORROWER_DUPLICATE_DEBIT' => __('Reverse the extra borrower or guarantor charge, or post the missing guarantor cash top-up bridge.'),
    ...
    private static function codeTitles(): array
    {
        return [
            ...
            'GUARANTOR_BORROWER_DUPLICATE_DEBIT' => __('Guarantor cover without cash top-up'),
    ...
    private static function codeSummaries(): array
    {
        return [
            ...
            'GUARANTOR_BORROWER_DUPLICATE_DEBIT' => __('Both guarantor fund and borrower cash were debited for this installment without a matching borrower cash top-up from the guarantor.'),
