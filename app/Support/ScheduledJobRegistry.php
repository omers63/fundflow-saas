...
final class ScheduledJobRegistry
{
    ...
    public static function all(): array
    {
        return [
            ...
            self::job('loans:shift-single-overdue-grace', __('Shift single-overdue schedules (grace)'), __('One-time: loans with no beginning grace and exactly one overdue cycle — push unpaid EMIs forward by the chosen grace cycles'), __('Manual only (one-time)'), 'loans', false),
