...
class MasterAccountInvariantService
{
     ...
     *     master_invest_return_to_fund_credits: float,
     *     master_invest_balance: float,
     *     master_expense_balance: float,
     *     master_fees_balance: float,
     *     master_suspense_balance: float,
     *     master_bank_balance: float,
    ...
    public function check(): array
    {
        ...
        return [
            ...
            'master_invest_return_to_fund_credits' => $masterFundFromInvestReturns,
            'master_invest_balance' => (float) (Account::masterInvest()?->balance ?? 0),
            'master_expense_balance' => (float) (Account::masterExpense()?->balance ?? 0),
            'master_fees_balance' => (float) (Account::masterFees()?->balance ?? 0),
            'master_suspense_balance' => (float) (Account::masterSuspense()?->balance ?? 0),
            'master_bank_balance' => (float) (Account::masterBank()?->balance ?? 0),
