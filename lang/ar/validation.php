...
return [
    ...
    'doesnt_contain' => 'يجب ألا يحتوي حقل :attribute على أيٍّ مما يلي: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'ظهرت :attribute في تسريب بيانات. يرجى اختيار :attribute مختلف.',
    ],
    ...
    'attributes' => [
        ...
        'pin' => 'رمز PIN',
        'pin_confirmation' => 'تأكيد رمز PIN',
        'preferred_locale' => 'اللغة المفضلة',
        'data.name' => 'الاسم',
        'data.email' => 'البريد الإلكتروني',
        'data.phone' => 'الهاتف',
        'data.new_password' => 'كلمة المرور الجديدة',
        'data.new_password_confirmation' => 'تأكيد كلمة المرور الجديدة',
        'data.current_password' => 'كلمة المرور الحالية',
        'data.pin' => 'رمز PIN',
        'data.pin_confirmation' => 'تأكيد رمز PIN',
        'data.preferred_locale' => 'اللغة المفضلة',
    ],
];
