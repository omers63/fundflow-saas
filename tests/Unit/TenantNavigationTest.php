...
test('tenant navigation group keys are finance operations then system', function () {
    expect(TenantNavigation::GROUP_ACCOUNTS)->toBe('Finance')
        ...
        ->and(TenantNavigation::SORT_CONTRIBUTIONS)->toBeLessThan(TenantNavigation::SORT_LOANS)
        ->and(TenantNavigation::SORT_LOANS)->toBeLessThan(TenantNavigation::SORT_DISBURSEMENTS)
        ->and(TenantNavigation::SORT_DISBURSEMENTS)->toBeLessThan(TenantNavigation::SORT_DELINQUENCY)
        ->and(TenantNavigation::SORT_DELINQUENCY)->toBeLessThan(TenantNavigation::SORT_DEPOSITS)
